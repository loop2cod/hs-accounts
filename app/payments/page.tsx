          ...
          {payments.length === 0 ? (
            ...
            <div className="divide-y divide-slate-100">
              {payments.map((p) => (
                <div
                  key={p._id}
                  className="flex items-center justify-between p-2 hover:bg-slate-50 transition-colors group"
                >
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                    ...
                    <div className="space-y-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-slate-500">
                        ...
                        <span className="px-2 py-0.5 bg-slate-100 text-slate-600 rounded-md font-bold uppercase tracking-wider text-[10px] whitespace-nowrap">
                          {p.paymentMode}
                        </span>
                      </div>
                    </div>
